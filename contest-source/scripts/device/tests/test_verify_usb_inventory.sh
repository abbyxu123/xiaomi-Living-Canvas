...
{"SPUSBDataType":[{"_items":[{"_name":"Debug Bridge","manufacturer":"NuttX","product_id":"0x4e11","serial_num":"1234","vendor_id":"0x18d1"},{"_name":"Radar","manufacturer":"Espressif","serial_num":"10:BD:A3:9F:6A:10","vendor_id":"0x303a"},{"_name":"Camera","manufacturer":"Espressif","serial_num":"A4:CB:8F:D1:4F:5C","vendor_id":"0x303a"}]}]}
JSON
...
grep -q 'mmWave: MISSING' "$FIXTURES/out"
grep -q 'Camera: MISSING' "$FIXTURES/out"
...
assert_success "all recorded identities pass strict mode" "$SCRIPT_UNDER_TEST" --require-all --inventory-json "$FIXTURES/all-devices.json"
